// window.onload = function() {
    ...
    function loadPage(sortBy) {
        ...
        rootRef.orderByChild(sortBy).on("child_added", snap => {
            ...
            // console.log(storageRef.child(image).getDownloadURL())
            ...
            $("#table_body").append("<tr><td> <img src='"+ url +"' width='100px' height='100px;' > </img> </td><td>" + email + "</td><td>" + city + "</td><td>" + addr + "</td><td>" + desc + "</td><td>" + rating + "</td></tr>");
            ...
            // $("#table_body").append("<tr><td> <img alt='' width='100px' height='100px;' >"+ image + " </img> </td><td>" + email + "</td><td>" + city + "</td><td>" + addr + "</td><td>" + desc + "</td><td>" + rating + "</td></tr>");
